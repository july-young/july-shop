package com.july.shop.goods.es.util;

import com.alibaba.fastjson.JSON;
import com.july.shop.goods.entity.EsEntity;
...
public class EsUtil {
    ...
    public static final String INDEX_NAME = "init_test_index";
...
//            System.exit(0);
    ...
    public <T> List<T> search( SearchSourceBuilder builder, Class<T> c) {
        ...
        return search(c.getName().replace("Entity","").toLowerCase(),builder,c);
    }
